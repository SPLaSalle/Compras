...
function resetcompras1() {
    document.getElementById('autor1').innerHTML = "";
...
function defaultViewModel() {
    ...
    self.resetcompras = function () {
        ...
        clientContext.executeQueryAsync(
            Function.createDelegate(self, self._onLoadListSucceedea),
            Function.createDelegate(self, self._onLoadListFailed)
            );
    }

    self._onLoadListSucceedea = function (sender, args) {
